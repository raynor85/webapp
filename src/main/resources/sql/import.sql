...
-- Songbird
INSERT INTO applicationreference(id, creationdate, updatedate, version, active, globalurl, iconfilename, name, apiname) VALUES (nextval('application_reference_seq'), now(), null, 0, false, 'http://sourceforge.net/projects/songbird.mirror/', 'songbird.png', 'Songbird', 'songbird');
-- Picasa
INSERT INTO applicationreference(id, creationdate, updatedate, version, active, globalurl, iconfilename, name, apiname) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://picasa.google.com/', 'picasa.png', 'Picasa', 'picasa');
-- iTunes
...
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-05-09 19:00:00.643', '29.0.1', 'https://download.mozilla.org/?product=firefox-29.0.1-SSL&os=win&lang=en-US', 'https://download.mozilla.org/?product=firefox-29.0.1-SSL&os=win&lang=fr', NULL, NULL, (select id from applicationreference where apiname = 'firefox'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2013-08-17 19:00:00.768', '3.5.11', 'http://www.dotpdn.com/files/Paint.NET.3.5.11.Install.zip', NULL, NULL, NULL, (select id from applicationreference where apiname = 'paintnet'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-06-02 19:00:01.899', '6.6.3', 'http://download.tuxfamily.org/notepadplus/6.6.3/npp.6.6.3.Installer.exe', NULL, NULL, NULL, (select id from applicationreference where apiname = 'notepadplusplus'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2013-11-28 19:00:11.082', '2.8.10', 'http://download.gimp.org/pub/gimp/v2.8/windows/gimp-2.8.10-setup.exe', NULL, NULL, NULL, (select id from applicationreference where apiname = 'gimp'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-05-13 19:00:11.661', '11.0.07', 'http://www.adobe.com/support/downloads/detail.jsp?ftpID=5784', NULL, NULL, NULL, (select id from applicationreference where apiname = 'adobereader'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2013-06-19 19:00:12.349', '2.1.3', '//get.videolan.org/vlc/2.1.3/win32/vlc-2.1.3-win32.exe', NULL, 'http://download.videolan.org/pub/videolan/vlc/last/win64/', NULL, (select id from applicationreference where apiname = 'vlcmediaplayer'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-05-01 19:00:12.711', '1.7.5', 'http://sourceforge.net/projects/mpc-hc/files/MPC%20HomeCinema%20-%20Win32/MPC-HC_v1.7.5_x86/MPC-HC.1.7.5.x86.exe/download', NULL, 'http://sourceforge.net/projects/mpc-hc/files/MPC%20HomeCinema%20-%20x64/MPC-HC_v1.7.5_x64/MPC-HC.1.7.5.x64.exe/download', NULL, (select id from applicationreference where apiname = 'mediaplayerclassic'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-05-22 19:00:13.021', '4.14.4707', 'http://www.piriform.com//ccleaner/download/standard', NULL, NULL, NULL, (select id from applicationreference where apiname = 'ccleaner'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-06-01 19:00:14.139', '3.8.1', 'http://sourceforge.net/projects/filezilla/files/FileZilla_Client/3.8.1/FileZilla_3.8.1_win32-setup.exe/download?nowrap', NULL, NULL, NULL, (select id from applicationreference where apiname = 'filezilla'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-06-02 19:00:14.801', '37.0.2001.0', 'https://storage.googleapis.com/chromium-browser-continuous/Win/271314/mini_installer.exe', NULL, 'https://storage.googleapis.com/chromium-browser-continuous/Win_x64/271314/mini_installer.exe', NULL, (select id from applicationreference where apiname = 'chromium'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2013-11-07 00:00:10.502', '13.0.1.3', 'http://www.adobe.com/support/downloads/detail.jsp?ftpID=5677', NULL, NULL, NULL, (select id from applicationreference where apiname = 'adobephotoshop'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2010-11-18 00:00:11.446', '9.20', 'http://downloads.sourceforge.net/sevenzip/7z920.exe', NULL, 'http://downloads.sourceforge.net/sevenzip/7z920-x64.msi', NULL, (select id from applicationreference where apiname = '7zip'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-04-29 00:00:12.266', '24.5.0', 'https://download.mozilla.org/?product=thunderbird-24.5.0&os=win&lang=en-US', 'https://download.mozilla.org/?product=thunderbird-24.5.0&os=win&lang=fr', NULL, NULL, (select id from applicationreference where apiname = 'thunderbird'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-06-04 00:00:12.831', '2.10.9', 'http://sourceforge.net/projects/pidgin/files/Pidgin/2.10.9/pidgin-2.10.9.exe/download', NULL, NULL, NULL, (select id from applicationreference where apiname = 'pidgin'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-06-04 00:00:13.047', '10.5', 'http://www.free-codecs.com/download_soft.php?d=7405&s=775&r=', NULL, NULL, NULL, (select id from applicationreference where apiname = 'klitecodecs'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2013-02-04 00:00:14.647', '2.2.0', 'http://sourceforge.net/projects/songbird.mirror/files/latest/download', NULL, NULL, NULL, (select id from applicationreference where apiname = 'songbird'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-05-12 00:00:14.716', '3.9', 'https://dl.google.com/picasa/picasa39-setup.exe', NULL, NULL, NULL, (select id from applicationreference where apiname = 'picasa'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-05-28 00:00:16.115', '11.2.2', 'https://secure-appldnld.apple.com/iTunes11/031-02995.20140528.Tadim/iTunesSetup.exe', NULL, 'https://secure-appldnld.apple.com/iTunes11/031-02993.20140528.Pu4r5/iTunes64Setup.exe', NULL, (select id from applicationreference where apiname = 'itunes'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2013-02-02 00:00:16.755', '2.14.0', 'http://downloads.sourceforge.net/winmerge/WinMerge-2.14.0-Setup.exe', NULL, NULL, NULL, (select id from applicationreference where apiname = 'winmerge'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-04-25 00:00:17.157', '1.7.3', 'http://download.pdfforge.org/download/pdfcreator/PDFCreator-stable', NULL, NULL, NULL, (select id from applicationreference where apiname = 'pdfcreator'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-06-05 00:00:03.576', '6.6.4', 'http://download.tuxfamily.org/notepadplus/6.6.4/npp.6.6.4.Installer.exe', NULL, NULL, NULL, (select id from applicationreference where apiname = 'notepadplusplus'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-06-06 00:00:15.129', '37.0.2031.0', 'https://storage.googleapis.com/chromium-browser-continuous/Win/274979/mini_installer.exe', NULL, 'https://storage.googleapis.com/chromium-browser-continuous/Win_x64/274979/mini_installer.exe', NULL, (select id from applicationreference where apiname = 'chromium'));
INSERT INTO applicationversion VALUES (nextval('application_version_seq'), now(), NULL, 0, '2014-06-06 00:00:18.135', '10.5.5', 'http://www.free-codecs.com/download_soft.php?d=7405&s=775&r=', NULL, NULL, NULL, (select id from applicationreference where apiname = 'klitecodecs'));
