...
-- PDFCreator
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.pdfforge.org/pdfcreator/download', 'pdfcreator.png', 'PDFCreator', 'pdfcreator', true, 'APPLICATION');
-- Avast
...
-- Recuva
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.piriform.com/recuva/download', 'recuva.png', 'Recuva', 'recuva', false, 'APPLICATION');
-- Defraggler
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.piriform.com/defraggler/download', 'defraggler.png', 'Defraggler', 'defraggler', false, 'APPLICATION');
-- Process Explorer
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://technet.microsoft.com/en-us/sysinternals/bb896653.aspx', 'processexplorer.png', 'Process Explorer', 'processexplorer', false, 'APPLICATION');
-- Autoruns
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://technet.microsoft.com/en-us/sysinternals/bb963902.aspx', 'autoruns.png', 'Autoruns', 'autoruns', false, 'APPLICATION');
-- Look 'n' Stop
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.looknstop.com/En/download.htm', 'looknstop.png', 'Look ''n'' Stop', 'looknstop', false, 'APPLICATION');
-- RocketDock
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://rocketdock.com/DOWNLOAD', 'rocketdock.png', 'RocketDock', 'rocketdock', false, 'APPLICATION');
-- ObjectDock
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://download.cnet.com/ObjectDock/3000-2072_4-10210264.html', 'objectdock.png', 'ObjectDock', 'objectdock', false, 'APPLICATION');
-- Maxthon
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.maxthon.com', 'maxthon.png', 'Maxthon', 'maxthon', false, 'APPLICATION');
-- CuteFTP
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.cuteftp.com/trial.aspx', 'cuteftp.png', 'CuteFTP', 'cuteftp', false, 'APPLICATION');
-- CPU-Z
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.cpuid.com/softwares/cpu-z.html', 'cpuz.png', 'CPU-Z', 'cpuz', false, 'APPLICATION');
-- Docker
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'https://github.com/boot2docker/windows-installer/releases', 'docker.png', 'Docker', 'docker', false, 'APPLICATION');
-- Dropbox
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'https://www.dropbox.com/install', 'dropbox.png', 'Dropbox', 'dropbox', false, 'APPLICATION');
-- Torch Browser
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://download.cnet.com/Torch-Browser/3000-2356_4-75740051.html', 'torchbrowser.png', 'Torch Browser', 'torchbrowser', false, 'APPLICATION');
-- Power ISO
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.poweriso.com/download.htm', 'poweriso.png', 'Power ISO', 'poweriso', false, 'APPLICATION');
-- Nero Burning ROM
INSERT INTO applicationreference(id, creationdate, updatedate, dbversion, active, globalurl, iconfilename, name, apiname, notified, category) VALUES (nextval('application_reference_seq'), now(), null, 0, true, 'http://www.nero.com/eng/products/nero-burning-rom/free-trial-download-started.php?email=test%40test.com', 'neroburningrom.png', 'Nero Burning ROM', 'neroburningrom', false, 'APPLICATION');
