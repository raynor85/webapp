...
public class PdfCreatorRemoteRetriever implements RemoteRetriever {
	...
	public boolean support(ApplicationReference applicationReference) {
		return applicationReference.getName().equalsIgnoreCase("PDFCreator");
	}
	...
	public String retrieveVersionNumber(Document doc) {
		return ParseUtils.extractVersionNumberFromString(doc.select("h2:contains(PDFCreator)").first().text());
	}
