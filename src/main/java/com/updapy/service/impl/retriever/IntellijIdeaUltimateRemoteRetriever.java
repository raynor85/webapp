...
public class IntellijIdeaUltimateRemoteRetriever implements RemoteRetriever {
	...
	private static final String ROOT_DOWNLOAD_WEBSITE = "http://download-cf.jetbrains.com/idea/ideaIU-" + PATTERN_VERSION + ".exe";

	@Override
	public boolean support(ApplicationReference application) {
		return application.getName().equalsIgnoreCase("IntelliJ IDEA Ultimate");
	}
