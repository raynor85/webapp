...
public class RetrievalErrorIgnoredApplication {
	...
	public static final List<String> DIFFERENT_URL_IGNORED_APPLICATIONS = Arrays.asList("chromium", "aviraantivirusfree");
	
	// Hardcoded list of ignored application when the new version of the app has been added manually
	public static final List<String> VERSION_HIGHER_IGNORED_APPLICATIONS = Arrays.asList("phraseexpress", "comodointernetsecurity");
}
