...
public class GithubExeRemoteRetriever implements RemoteRetriever, BaseUrlRemoteRetriever {
	...
	public boolean support(ApplicationReference application) {
		...
		return apiName.equalsIgnoreCase("docker") || apiName.equalsIgnoreCase("openbroadcastersoftware") || apiName.equalsIgnoreCase("obsstudio") || apiName.equalsIgnoreCase("clementineplayer") || apiName.equalsIgnoreCase("dockertoolbox") || apiName.equalsIgnoreCase("conemu") || apiName.equalsIgnoreCase("processhacker");
	}
