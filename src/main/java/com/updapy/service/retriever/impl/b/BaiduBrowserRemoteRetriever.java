...
public class BaiduBrowserRemoteRetriever implements RemoteRetriever, BaseUrlRemoteRetriever {
	...
	public boolean support(ApplicationReference application) {
		return application.getApiName().equalsIgnoreCase("baidubrowser");
	}
	...
	public String retrieveWin32UrlEn(Document doc) throws IOException {
		return ParsingUtils.buildUrl(ROOT_DOWNLOAD_WEBSITE, doc.select("a:contains(Get offline installer)[href*=.exe]").attr("href"));
	}
