...
public class CnetDownloadRemoteRetriever extends OriginalUrlRemoteRetriever implements RemoteRetriever {
	...
	public boolean support(ApplicationReference application) {
		...
		return apiName.equalsIgnoreCase("avast") || apiName.equalsIgnoreCase("slimdrivers") || apiName.equalsIgnoreCase("skype") || apiName.equalsIgnoreCase("advancedsystemcare") || apiName.equalsIgnoreCase("ytdvideodownloader") || apiName.equalsIgnoreCase("adawarefree") || apiName.equalsIgnoreCase("smartdefrag") || apiName.equalsIgnoreCase("virtualdj") || apiName.equalsIgnoreCase("photoscape") || apiName.equalsIgnoreCase("drivermax") || apiName.equalsIgnoreCase("primopdf")
				...
				|| apiName.equalsIgnoreCase("pandafreeantivirus") || apiName.equalsIgnoreCase("iobituninstaller") || apiName.equalsIgnoreCase("fences") || apiName.equalsIgnoreCase("zonerphotostudio") || apiName.equalsIgnoreCase("comododragonbrowser") || apiName.equalsIgnoreCase("comodoicedragon") || apiName.equalsIgnoreCase("comodochromodo") || apiName.equalsIgnoreCase("wunderlist") || apiName.equalsIgnoreCase("avginternetsecurity") || apiName.equalsIgnoreCase("spotify")
				|| apiName.equalsIgnoreCase("wiseuninstaller") || apiName.equalsIgnoreCase("wiseregistrycleaner") || apiName.equalsIgnoreCase("wisediskcleaner") || apiName.equalsIgnoreCase("wiseautoshutdown");
	}
