			...
			<div class="not-found">
				<div class="not-found-header">
					<span class="background-color"> 
						<i class="fa fa-eye-slash fa-5x text-white random animated2 rotateIn"></i>
					...
					<span class="background-color">
						<i class="fa fa-eye-slash fa-5x text-white random2 animated2 rotateIn delay1"></i>
					...
					<span class="background-color">
						<i class="fa fa-eye-slash fa-5x text-white random3 animated2 rotateIn delay2"></i>
				...
				<h3 class="text-center">
					<spring:message code="error.403.description.short" />
				</h3>
				<p class="text-center text-muted">
					<spring:message code="error.403.description.long" />
				</p>
			</div>
		</div>
	</div>
