	...
	<div class="container">
	  <footer>
		  <ul class="list-inline pull-left">
			...
			<li><a href="<spring:message code="application.twitter.url" />" class="text-muted fa fa-twitter fa-2x no-underline"></a></li>
			<li><span class="text-muted"><spring:message code="footer.follow.part2" /></span></li>
			<li><a href="<spring:message code="application.facebook.url" />" class="text-muted fa fa-facebook fa-2x no-underline"></a></li>
		  </ul>
		  <ul class="list-inline pull-right-xs" style="margin-top:6px;">
			<li><span class="text-muted"><spring:message code="footer.version" /> <spring:message code="updapy.version" /></span></li>
			<li><span class="text-muted">I</span></li>
